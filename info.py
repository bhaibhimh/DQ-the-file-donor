...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/night_shadowz')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/shadow_linkz')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'night_shadowz')
